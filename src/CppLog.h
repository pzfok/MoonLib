...
#define CHECK_OP_FI(cppLog, expr, op, logLevel, format, ...) if (unlikely(!(expr))){Log((cppLog), logLevel, "Check [" #expr "] Failed,op[" #op "]." format, ##__VA_ARGS__);op;}
...
// 检查，不符合条件则return
#define CHECK_RETURN_FI(cppLog, expr, ret, logLevel, format, ...) CHECK_OP_FI((cppLog), expr, return ret, logLevel, format, ##__VA_ARGS__)
...
#define WARNN_CHECK_RETURN_FI(cppLog, expr, ret, format, ...) CHECK_RETURN_FI((cppLog), expr, ret, CppLog::WARNN, format, ##__VA_ARGS__)
...
#define CHECK_RETURN_VOID_I(cppLog, expr, logLevel) CHECK_RETURN_VOID_FI((cppLog), expr, logLevel, "")
#define RET_RETURN_VOID_I(cppLog, ret, logLevel) RET_RETURN_VOID_FI((cppLog), ret, logLevel, "")

#define WARNN_CHECK_RETURN_VOID_FI(cppLog, expr, format, ...) CHECK_RETURN_VOID_FI((cppLog), expr, CppLog::WARNN, format, ##__VA_ARGS__)
...
#define CHECK_BREAK_I(cppLog, expr, logLevel) CHECK_BREAK_FI((cppLog), expr, logLevel, "")
#define RET_BREAK_I(cppLog, ret, logLevel) RET_BREAK_FI((cppLog), ret, logLevel, "")

#define WARNN_CHECK_BREAK_FI(cppLog, expr, format, ...) CHECK_BREAK_FI((cppLog), expr, CppLog::WARNN, format, ##__VA_ARGS__)
...
#define WARNN_CHECK_CONTINUE_FI(cppLog, expr, format, ...) CHECK_CONTINUE_FI((cppLog), expr, CppLog::WARNN, format, ##__VA_ARGS__)
...
// 检查，不符合条件则return
#define CHECK_RETURN_F(expr, ret, logLevel, format, ...) CHECK_OP_FI((CPP_LOG_INSTANCE), expr,  return ret, logLevel, format, ##__VA_ARGS__)
...
#define WARNN_CHECK_RETURN_F(expr, ret, format, ...) CHECK_RETURN_FI((CPP_LOG_INSTANCE), expr, ret, CppLog::WARNN, format, ##__VA_ARGS__)
...
#define CHECK_RETURN_VOID(expr, logLevel) CHECK_RETURN_VOID_FI((CPP_LOG_INSTANCE), expr, logLevel, "")
#define RET_RETURN_VOID(ret, logLevel) RET_RETURN_VOID_FI((CPP_LOG_INSTANCE), ret, logLevel, "")

#define WARNN_CHECK_RETURN_VOID_F(expr, format, ...) CHECK_RETURN_VOID_FI((CPP_LOG_INSTANCE), expr, CppLog::WARNN, format, ##__VA_ARGS__)
...
#define CHECK_BREAK(expr, logLevel) CHECK_BREAK_FI((CPP_LOG_INSTANCE), expr, logLevel, "")
#define RET_BREAK(ret, logLevel) RET_BREAK_FI((CPP_LOG_INSTANCE), ret, logLevel, "")

#define WARNN_CHECK_BREAK_F(expr, format, ...) CHECK_BREAK_FI((CPP_LOG_INSTANCE), expr, CppLog::WARNN, format, ##__VA_ARGS__)
...
#define CHECK_CONTINUE(expr, logLevel) CHECK_CONTINUE_FI((CPP_LOG_INSTANCE), expr, logLevel, "")
#define RET_CONTINUE(ret, logLevel) RET_CONTINUE_FI((CPP_LOG_INSTANCE), ret, logLevel, "")

#define WARNN_CHECK_CONTINUE_F(expr, format, ...) CHECK_CONTINUE_FI((CPP_LOG_INSTANCE), expr, CppLog::WARNN, format, ##__VA_ARGS__)
